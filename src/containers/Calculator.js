...
function App() {
  ...
  var runningTotalOutput;

  if(runningTotal == 'Infinity'){
    runningTotalOutput = "ERROR"    
  } else {
    runningTotalOutput = runningTotal;
  }

  return (
    <div className="container">
    <div className="calculator">
      <div data-testid="running-total" id="running-total" className="display">{ runningTotalOutput }</div>
      <KeyPad 
